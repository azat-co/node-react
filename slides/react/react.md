...
Let's use npm to make it close to real web development flow
...
1. 3+ buttons
2. 3+ components: 2 presentational and one smart
3. Webpack, JSX, Babel, modules, npm

---

# Workshop: Timer Solution
